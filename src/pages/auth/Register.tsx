...
function Register() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!email.trim() || !emailRegex.test(email) || !name.trim() || !password.trim()) return
        ...
        try {
            ...
            const message = typeof data === "string" ? data : (data?.message as string) || (data?.error as string) || "Registration failed"
            setError(message)
        } finally {
            setLoading(false)
        }
